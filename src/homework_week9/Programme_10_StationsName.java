...
public class Programme_10_StationsName {
    ...
    public static void main(String[] args) {
        char c;
        // Create a HashMap object called zone
        HashMap<String, String> zone = new HashMap<>();
        // Add keys and values (StationName, TubeLine)
        ...
        do {
           ...
           // String stationName1 = stationName.equalsIgnoreCase();
            ...
            System.out.println("input station name is not in Zone 1 kindly search zone 1 station");
